...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@ionic/core/css/core.css" integrity="...">
...
<div class="bg-white flex items-center justify-center ">
    <div class=" text-gray-500 rounded shadow-xl py-5 px-5 w-full lg:w-1/2" x-data="{chartData:chartData()}" x-init="chartData.fetch()">
        <div class="flex flex-wrap items-end">
            <div class="flex-1">
                <h3 class="color-black text-lg font-semibold leading-tight">Income</h3>
            </div>
        ...
        <div class="flex flex-wrap items-end mb-5">
            <h4 class="text-2xl lg:text-3xl text-black font-semibold leading-tight inline-block mr-2" x-text="'$'+(chartData.data?chartData.data[chartData.date].total.comma_formatter():0)">0</h4>
        ...
        <div>    <script src="https://cdn.jsdelivr.net/gh/alpinejs/alpine@v2.x.x/dist/alpine.js" defer></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.3/Chart.min.js" defer></script>
            ...
            let chart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [
                        {
                            label: "Income",
                            backgroundColor: "rgba(47, 126, 121, 0.25)",
                            borderColor: "rgba(47, 126, 121, 1)",
                            pointBackgroundColor: "rgba(47, 126, 121, 1)",
